...
- {pin_num: '93', pin_signal: PTD0/LLWU_P12/SPI0_PCS0/UART2_RTS_b/FTM3_CH0/FB_ALE/FB_CS1_b/FB_TS_b, label: 'J2[6]', identifier: LOGIC_CHANNEL_0;LOGIC_CHANNEL0}
- {pin_num: '95', pin_signal: PTD2/LLWU_P13/SPI0_SOUT/UART2_RX/FTM3_CH2/FB_AD4/I2C0_SCL, label: 'J2[8]', identifier: UART2_RX;LOGIC_CHANNEL2}
- {pin_num: '96', pin_signal: PTD3/SPI0_SIN/UART2_TX/FTM3_CH3/FB_AD3/I2C0_SDA, label: 'J2[10]', identifier: UART2_TX;LOGIC_CHANNEL3}
- {pin_num: '94', pin_signal: ADC0_SE5b/PTD1/SPI0_SCK/UART2_CTS_b/FTM3_CH1/FB_CS0_b, label: 'J2[12]', identifier: LOGIC_CHANNEL1}
...
- {pin_num: '83', pin_signal: ADC1_SE7b/PTC11/LLWU_P11/I2C1_SDA/FTM3_CH7/I2S0_RXD1/FB_RW_b, label: 'J4[10]', identifier: TEST_PIN1}
- {pin_num: '82', pin_signal: ADC1_SE6b/PTC10/I2C1_SCL/FTM3_CH6/I2S0_RX_FS/FB_AD5, label: 'J4[12]', identifier: TEST_PIN0}
...
- pin_list:
  ...
  - {pin_num: '93', peripheral: GPIOD, signal: 'GPIO, 0', pin_signal: PTD0/LLWU_P12/SPI0_PCS0/UART2_RTS_b/FTM3_CH0/FB_ALE/FB_CS1_b/FB_TS_b, identifier: LOGIC_CHANNEL0,
    direction: INPUT, slew_rate: slow, drive_strength: low}
  - {pin_num: '94', peripheral: GPIOD, signal: 'GPIO, 1', pin_signal: ADC0_SE5b/PTD1/SPI0_SCK/UART2_CTS_b/FTM3_CH1/FB_CS0_b, direction: INPUT, slew_rate: slow, drive_strength: low}
  - {pin_num: '95', peripheral: GPIOD, signal: 'GPIO, 2', pin_signal: PTD2/LLWU_P13/SPI0_SOUT/UART2_RX/FTM3_CH2/FB_AD4/I2C0_SCL, identifier: LOGIC_CHANNEL2, direction: INPUT,
    slew_rate: slow, drive_strength: low}
  - {pin_num: '96', peripheral: GPIOD, signal: 'GPIO, 3', pin_signal: PTD3/SPI0_SIN/UART2_TX/FTM3_CH3/FB_AD3/I2C0_SDA, identifier: LOGIC_CHANNEL3, direction: INPUT,
    slew_rate: slow, drive_strength: low}
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t TEST_PIN0_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTC10 (pin 82)  */
    GPIO_PinInit(BOARD_TEST_PIN0_GPIO, BOARD_TEST_PIN0_PIN, &TEST_PIN0_config);

    gpio_pin_config_t TEST_PIN1_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTC11 (pin 83)  */
    GPIO_PinInit(BOARD_TEST_PIN1_GPIO, BOARD_TEST_PIN1_PIN, &TEST_PIN1_config);

    gpio_pin_config_t LOGIC_CHANNEL0_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTD0 (pin 93)  */
    GPIO_PinInit(BOARD_LOGIC_CHANNEL0_GPIO, BOARD_LOGIC_CHANNEL0_PIN, &LOGIC_CHANNEL0_config);

    gpio_pin_config_t LOGIC_CHANNEL1_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTD1 (pin 94)  */
    GPIO_PinInit(BOARD_LOGIC_CHANNEL1_GPIO, BOARD_LOGIC_CHANNEL1_PIN, &LOGIC_CHANNEL1_config);

    gpio_pin_config_t LOGIC_CHANNEL2_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTD2 (pin 95)  */
    GPIO_PinInit(BOARD_LOGIC_CHANNEL2_GPIO, BOARD_LOGIC_CHANNEL2_PIN, &LOGIC_CHANNEL2_config);

    gpio_pin_config_t LOGIC_CHANNEL3_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTD3 (pin 96)  */
    GPIO_PinInit(BOARD_LOGIC_CHANNEL3_GPIO, BOARD_LOGIC_CHANNEL3_PIN, &LOGIC_CHANNEL3_config);
    ...
    PORT_SetPinMux(BOARD_TEST_PIN0_PORT, BOARD_TEST_PIN0_PIN, kPORT_MuxAsGpio);

    /* PORTC11 (pin 83) is configured as PTC11 */
    PORT_SetPinMux(BOARD_TEST_PIN1_PORT, BOARD_TEST_PIN1_PIN, kPORT_MuxAsGpio);

    /* PORTD0 (pin 93) is configured as PTD0 */
    PORT_SetPinMux(BOARD_LOGIC_CHANNEL0_PORT, BOARD_LOGIC_CHANNEL0_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_LOGIC_CHANNEL1_PORT, BOARD_LOGIC_CHANNEL1_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_LOGIC_CHANNEL2_PORT, BOARD_LOGIC_CHANNEL2_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_LOGIC_CHANNEL3_PORT, BOARD_LOGIC_CHANNEL3_PIN, kPORT_MuxAsGpio);
...
- pin_list:
  - {pin_num: '67', peripheral: GPIOB, signal: 'GPIO, 21', pin_signal: PTB21/SPI2_SCK/FB_AD30/CMP1_OUT, direction: OUTPUT, gpio_init_state: 'true', slew_rate: slow,
    open_drain: disable, drive_strength: high, pull_select: down, pull_enable: disable, passive_filter: disable}
  ...
  - {pin_num: '33', peripheral: GPIOE, signal: 'GPIO, 26', pin_signal: PTE26/ENET_1588_CLKIN/UART4_CTS_b/RTC_CLKOUT/USB_CLKIN, direction: OUTPUT, gpio_init_state: 'true',
    slew_rate: slow, open_drain: disable, drive_strength: high, pull_select: down, pull_enable: disable, passive_filter: disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
